...
// app/Http/Controllers/ExportPenilaianController.php
...
class ExportPenilaianController extends Controller
{
    ...
    {
        $data = PenerimaBantuan::all()->map(function ($p) {
        ...
        $pdf = Pdf::loadView('exports.penilaian-pdf', ['data' => $data]);
        return $pdf->download('penilaian_bantuan.pdf');
    }
}
